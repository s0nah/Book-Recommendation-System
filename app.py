...
image = Image.open('book_img.jpg')
st.image(image, caption=None)
st.title('Book recommandation System')
st.write('Please select user id from suggested list or Type')


# Recreate the model here
pop_list = pkl.load(open('pop_Df.pkl','rb'))
...
User_ID = st.selectbox('User-ID',(pop_list))
